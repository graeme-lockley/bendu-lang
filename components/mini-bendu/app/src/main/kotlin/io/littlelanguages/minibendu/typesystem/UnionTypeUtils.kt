...
object UnionTypeUtils {
    ...
    fun intersect(union1: UnionType, union2: UnionType): Set<Type> =
        union1.alternatives.filter { alt1 ->
    ...
    fun isMemberOf(type: Type, unionType: UnionType): Boolean =
        unionType.alternatives.any { alternative ->
