            ...
            testCases.add(
                TestCase(
                    ...
                    expectedError = if (expectedType?.contains("error", ignoreCase = true) == true || 
                                         ...
                                         expectedType?.contains("unify", ignoreCase = true) == true) expectedType else null
                )
            )
        }
    ...
    private fun executeTestCase(testCase: TestCase) {
        ...
        when {
            testCase.expectedError != null -> {
                assertTrue(result is TypeCheckResult.Failure, 
            ...
            testCase.expectedType != null -> {
                assertTrue(result is TypeCheckResult.Success, 
